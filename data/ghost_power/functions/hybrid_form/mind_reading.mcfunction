...
execute at @a[tag=hybrid] as @a[tag=hybrid] run execute if entity @e[tag=!spectral,type=!#minecraft:dontharm,distance=..15,limit=1,sort=nearest] run tag @s add valide
...
execute at @a[tag=hybrid] run execute if entity @e[tag=!spectral,type=!#minecraft:dontharm,distance=..15,limit=1,sort=nearest] run effect give @e[tag=!spectral,type=!#minecraft:dontharm,distance=..15,limit=1,sort=nearest] glowing 3 2 true
